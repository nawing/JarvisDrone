	...
	var AppModule = (function () {
	    ...
	    AppModule = __decorate([
	        core_1.NgModule({
	            bootstrap: [app_1.App],
	            declarations: [
	                home_1.Home, login_1.Login, signup_1.Signup, profile_1.Profile, gesture_1.Gesture, keyboard_1.Keyboard, voice_1.Voice,
	                header_1.Header, footer_1.Footer, nav_1.Nav,
	                app_1.App
	            ],
	            imports: [
...
/***/ (function(module, exports, __webpack_require__) {
	...
	(function (global, factory) {
	     true ? factory(exports, __webpack_require__(4), __webpack_require__(57), __webpack_require__(5), __webpack_require__(6), __webpack_require__(52)) :
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Home = (function () {
	    ...
	    Home.prototype.controlSubmit = function (status) {
	        var body = {};
	        var Api = {
	            url: status,
	            body: body
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var core_1 = __webpack_require__(4);
	var http_1 = __webpack_require__(55);
	var headers_1 = __webpack_require__(65);
	var http_2 = __webpack_require__(55);
	var router_1 = __webpack_require__(25);
	__webpack_require__(66);
	__webpack_require__(67);
	var HttpInterceptor = (function () {
	    function HttpInterceptor(http, router) {
	        this.http = http;
	        this.router = router;
	        this.baseUrl = 'http://localhost:8042/api/';
	        this.device = navigator.userAgent.toLowerCase();
	    }
	    HttpInterceptor.prototype.getLocation = function () {
	    ...
	    HttpInterceptor.prototype.parseBody = function (_body) {
	        this.getLocation();
	        this.formData = new http_2.URLSearchParams();
	        var __body = {
	            device: this.device,
	        ...
	        for (var key in __body) {
	            this.formData.append(key, __body[key]);
	        }
	        return this.formData;
	    };
	    HttpInterceptor.prototype.callApiPost = function (url, _body) {
	        var _this = this;
	        var parsedBody = this.parseBody(_body);
	    ...
	    HttpInterceptor.prototype.notify = function (type, message) {
	        $.notify({
	            icon: 'ti-gift',
	            message: message
	        }, {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.contentHeaders.append('Accept', 'application/x-www-form-urlencoded');
	exports.contentHeaders.append('Content-Type', 'application/x-www-form-urlencoded');
	exports.contentHeaders.append('Authorization', 'Bearer ' + token);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Profile = (function () {
	    ...
	    Profile.prototype.profileIndex = function () {
	        var _this = this;
	        var body = {
	            id: this.id,
	        ...
	        this.httpInterceptor.callApiPost(Api.url, Api.body)
	            .subscribe(function (res) {
	            console.log(res);
	            _this.profileObjects = res;
	        }, function (err) {
	        });
	    };
	    Profile.prototype.profileEdit = function () {
	        var _this = this;
	        var body = {
	            id: this.id,
	    ...
	    Profile = __decorate([
	        ...
	        __metadata('design:paramtypes', [router_1.Router, router_1.ActivatedRoute, interceptor_1.HttpInterceptor])
	    ], Profile);
	    return Profile;
	}());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Gesture = (function () {
	    ...
	    Gesture.prototype.ngOnInit = function () { };
	    Gesture.prototype.ngOnDestroy = function () { };
	    Gesture = __decorate([
	        core_1.Component({
	            selector: 'gesture',
	            template: template,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Keyboard = (function () {
	    ...
	    Keyboard.prototype.ngOnDestroy = function () { };
	    Keyboard = __decorate([
	        core_1.Component({
	            selector: 'keyboard',
	            template: template,
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Nav = (function () {
	    ...
	    Nav = __decorate([
	        ...
	        __metadata('design:paramtypes', [router_1.Router, interceptor_1.HttpInterceptor, auth_guard_1.AuthGuard])
	    ], Nav);
	    return Nav;
	}());
	exports.Nav = Nav;
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Header = (function () {
	    ...
	    ;
	    Header.prototype.ngDestroy = function () { };
	    ;
	    Header = __decorate([
	        core_1.Component({
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Footer = (function () {
	    ...
	    ;
	    Footer.prototype.ngDestroy = function () { };
	    ;
	    Footer = __decorate([
	        core_1.Component({
	        ...
	        __metadata('design:paramtypes', [router_1.Router, interceptor_1.HttpInterceptor])
	    ], Footer);
	    return Footer;
	}());
...
/***/ (function(module, exports, __webpack_require__) {
	...
	exports.routes = [
	    ...
	    { path: 'gesture', component: gesture_1.Gesture },
	    { path: 'keyboard', component: keyboard_1.Keyboard },
	    { path: 'voice', component: voice_1.Voice },
